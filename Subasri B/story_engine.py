...
class StoryEngine:
    ...
    def build_system_prompt(
        ...
        word_target = {
            "continue":       "200-350 words",
            "enhance":        "Match the length of the original passage",
            "rewrite":        "Match the length of the original passage",
            "twist":          "250-400 words",
            "dialogue":       "150-300 words of dialogue with beats",
            "describe":       "150-250 words of pure description",
            "foreshadow":     "180-320 words",
            "stakes":         "220-380 words",
            "flashback":      "220-420 words",
            "chapter_end":    "160-260 words",
            "overcome_block": "3 bullets + 180-260 words",
            "fix_pacing":     "Match the length of the original passage",
            "add_tension":    "Match the length of the original passage",
            "add_specifics":  "Match the length of the original passage",
            "deepen_emotion": "Match the length of the original passage",
            "vary_style":     "Match the length of the original passage",
        }.get(action_type, "200-350 words")
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
STORY SETTINGS — follow these exactly
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
GENRE:  {genre}
...
"""
    ...
    def build_user_message(
        ...
        if existing_story:
            ...
            excerpt = existing_story[-800:] if len(existing_story) > 800 else existing_story
            story_excerpt = f"""
